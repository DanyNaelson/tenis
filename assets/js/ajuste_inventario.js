		...
		if(event.keyCode == 13){
			if(almacen > 0){
				if(tipo_mov > 0){
					...
					$(this).val("");
					bootbox.alert("Debes seleccionar un tipo de movimiento para realizar la búsqueda del producto.");
				}
			}else{
				$(this).val("");
	...
	$("#finalizar").on("click", function(){
		...
		if(id_almacen != 0){
			if(count_tr > 1){
				...
				bootbox.alert("Necesitas agregar productos para registrar el ajuste de inventario.");
			}
		}else{
